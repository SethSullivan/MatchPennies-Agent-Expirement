\documentclass[man,donotrepeattitle,floatsintext,letterpaper,12pt]{apa7}
...
\noindent 44 participants participated across two experiments (collected in 2023). 20 individuals participated in \boldblue{Experiment 1} (mean age = 25.7, 8 female) and 24 individuals participated in \boldblue{Experiment 2} (mean age = 25.1, 9 female). All participants reported they were free from musculoskeletal injuries, neurological conditions, or sensory impairments. In addition to a base compensation of \$5.00, we informed them they would receive a performance-based compensation of up to \$5.00. Participants received the full \$10.00 once they completed the experiment irrespective of their performance. All participants provided written informed consent to participate in the experiment and the procedures were approved by the University of Delaware’s Institutional Review Board.

\subsection{Power Analysis}
For \boldblue{Experiment 1}, we performed a power analysis on the interaction term of a 3 x 2 repeated measures ANOVA ($\alpha$ = 0.05, $\beta$ = 0.2 [80\% power], f = 0.34). This yielded a sample size of 14, but we collected 20 participants. For \boldblue{Experiment 2}, we performed a power analysis on the interaction term of a 2 x 2 repeated measures ANOVA ($\alpha$ = 0.05, $\beta$ = 0.2 [80\% power], f = 0.41). This yielded a sample size of 15, but we collected 24 participants.
...
Data, analysis scripts, and computational modeling scripts are available on github (https://github.com/CashabackLab). This study and the subsequent analyses were not preregistered. 
