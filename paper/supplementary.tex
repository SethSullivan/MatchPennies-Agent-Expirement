...
\begin{figure}[H]
    ...
    \caption*{\boldblue{Supplementary Figure 9: Timing Uncertainty Experiment}. One of two potential targets (dashed white rings; not visible to participants) would appear on the screen. Once a target appeared (solid white ring), participants were instructed to rapidly move their cursor to hit the displayed target. We used the mean and standard deviation of response times as model parameters in the optimal transition models.}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption*{\boldblue{Supplementary Figure 10: Guess Decision Percentages for Experiment 1}. 
