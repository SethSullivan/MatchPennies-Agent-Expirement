...
\justify
\vspace{1.0mm}
We are writing to request that you consider our paper, \textcolor{myudblue}{\textbf{Indecision under time pressure arises from suboptimal switching behaviour}}, for publication in \emph{Journal of Neurophysiology}.
\vspace{3.0mm}
\\
