...
class Optimal_Decision_Time_Model():
    ...
    def calculate_experiment_metrics(self):
        ...
        self.prob_indecision_if_react = 1 - stats.norm.cdf(1500,self.trunc_agent_mean + self.reaction_plus_movement_time,self.reaction_reach_time_uncertainty) # Probability that the reach time reaction is > 1500 
